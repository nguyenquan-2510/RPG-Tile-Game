# This is the idea of the game
> Written the first time on ``12/11/2025``

> This file belongs to the `Develop` branch

> The develop branch is for pushing files before completing the game
***
- Ya a tile game (idk)
- Escape the dugeon
...
#### Objectives
- Learn the `anim8` and `sti` libraries again
- Proper organizing files and folders
- Metatable?